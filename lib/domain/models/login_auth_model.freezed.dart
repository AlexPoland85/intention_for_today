...
LoginAuthModel _$LoginAuthModelFromJson(Map<String, dynamic> json) {
  return _LoginAuthModel.fromJson(json);
}
...
class _$LoginAuthModelImpl extends _LoginAuthModel {
  ...
  factory _$LoginAuthModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$LoginAuthModelImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$LoginAuthModelImplToJson(
      this,
    );
  }
}
...
abstract class _LoginAuthModel extends LoginAuthModel {
  ...
  factory _LoginAuthModel.fromJson(Map<String, dynamic> json) =
      _$LoginAuthModelImpl.fromJson;
